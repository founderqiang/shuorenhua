...
### 对 Should NOT Fix（SNF-01 到 SNF-28）：
- 判断这条文本为什么不该改
- 如果保持原样或只做最小无害调整 → ✅ 通过
...
注意：token 窗口较短的模型可能无法一次跑完 66 条，可以分批（先跑 SF，再跑 SNF）。
