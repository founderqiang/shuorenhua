...
> v1.7.2 新增（首批 12 条），v1.7.3 扩到 14 条，v1.8.0 扩到 18 条。用来补 `benchmark.md` 的短板：benchmark 是合成的、结构清晰、病灶明显；
...
>
> 现在覆盖 210+ 中文词条，66 条 benchmark。如果你也在写 AI 会帮你起草的文档、release note、周报，欢迎试试，也欢迎提 bad case。
