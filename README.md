...
<p align="center">
  ...
  <a href="evals/benchmark.md"><img src="https://img.shields.io/badge/benchmark-66%20cases-2563eb?style=for-the-badge" alt="Benchmark: 66 cases"></a>
...
| 类型 | 数量 | 目标 |
|------|------|------|
| SF | 38 | 应该改的文本必须命中并改掉主要问题 |
| SNF | 28 | 不该误杀的文本必须放行或轻提示 |
...
当前用例集见 [evals/benchmark.md](evals/benchmark.md)。最近一次公开归档结果见 [evals/results-v1.8.3.md](evals/results-v1.8.3.md)，历史结果可参考 [evals/results-v1.8.0.md](evals/results-v1.8.0.md)、[evals/results-v1.7.4.md](evals/results-v1.7.4.md) 和 [evals/results-v1.7.1.md](evals/results-v1.7.1.md)。
